...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("liftToScaleHeight", new liftHeight(Robot.constants.midScaleHeight, 4.0));
        SmartDashboard.putData("liftToSwitchHeight", new liftHeight(Robot.constants.switchHeight, 4.0));
