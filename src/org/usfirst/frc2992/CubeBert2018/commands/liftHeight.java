...
public class liftHeight extends Command {
    ...
    public liftHeight(double height, double timeOut) {
    ...
    protected boolean isFinished() {
    	...
    	return ( Robot.liftClimber.atHeight() || liftTime.get() > m_timeOut);
    }

    // Called once after isFinished returns true
    @Override
    protected void end() {
    	// Make sure the PID gets disabled
    	Robot.liftClimber.stopLift();
    }
