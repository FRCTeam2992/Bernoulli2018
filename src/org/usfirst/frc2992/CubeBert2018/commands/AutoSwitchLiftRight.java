 ...
 *
 */
public class AutoSwitchLiftRight extends CommandGroup {

    public AutoSwitchLiftRight() {
        // Add Commands here:
        ...
        // arm.
    	addParallel(new AutoDriveFwd(84.55, 0.8, 3, true, 33.27));//12 in less than left
