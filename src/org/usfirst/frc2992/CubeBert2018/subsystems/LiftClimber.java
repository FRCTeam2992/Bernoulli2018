...
public class LiftClimber extends Subsystem {
    ...
    private final WPI_TalonSRX liftMotor = RobotMap.liftClimberliftMotor;
    ...
    private final WPI_TalonSRX climbMotor1 = RobotMap.liftClimberclimbMotor1;
    private final WPI_TalonSRX climbMotor2 = RobotMap.liftClimberclimbMotor2;
    ...
    private final Solenoid rightScaleClampSol = RobotMap.liftClimberrightScaleClampSol;
    private final Solenoid leftScaleClampSol = RobotMap.liftClimberleftScaleClampSol;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    private final PIDController liftPID = RobotMap.liftPID;
    
    private final double LiftUpPower = 0.5;
    private final double liftDownPower = -0.3;
