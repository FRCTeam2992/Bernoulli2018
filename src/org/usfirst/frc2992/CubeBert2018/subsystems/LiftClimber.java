 ...
 *
 */
public class LiftClimber extends Subsystem {
    ...
    public void liftUp(double speed) {
    	...
    	//or if lift is a certain height stop bc intake hit climb hooks
    	if(!liftTopSensor.get()==true || liftEnc.getDistance() == 33) {
    		stopLift();
    	}
    	else {
